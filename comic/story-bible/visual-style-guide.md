...
- For Muci, use one short positive model-sheet reminder whenever he appears: broad squat pure-white droplet, round heavy lower half, natural rounded top point with a consistent reader-left/page-left lean, curved rounded base, two attached small rounded feet, pure white body fill, large black dot eyes with catchlights, small friendly U-smile, upper reader-left oval-plus-dot highlights, and no brow by default.
...
- For Padaruna, explicitly preserve the very sharp upright centered pointed head, cute plump/chubby full rounded lively pear-bottom body, soft wide lower belly, visibly heavier rounded lower half, no side nubs or arm-like protrusions, no eyebrows, open dot eyes, and eager smile whenever she appears. When she appears with Nia, state that Padaruna is not Nia: Nia is taller, narrower, controlled, browed, and more vertical, while Padaruna stays browless, lively, lower-heavy, wide-bellied, and rounder at the base. When she appears with Muci, state that Padaruna is not Muci: she is about 1.1x Muci's overall body scale, keeps the sharper head and round buoyant energetic body, while Muci stays short, squat, soft-sided, and protagonist-friendly. If she shares a page with a right-leaning quiet droplet, Padaruna still keeps a very sharp upright centered point and chubby rounded body.
- For Padarana, explicitly preserve the slimmer soft pointed body, upright pointed head, closed smiling eyes, calm reassuring mouth, and gentle presence whenever she appears. If she shares a page with a right-leaning quiet droplet, Padarana still keeps her upright soft point and closed-eye warmth.
- When two or more of Muci, Nia, Snacri, Padaruna, and Padarana appear together, use the matching active-cast similar-character comparison reference and state their silhouette differences before describing acting.
- When two or more of Muci, Artrans, Padaruna, Padarana, Snacri, and Nia appear together, use the matching active-cast front-view height reference only as invisible production guidance. Never ask the image model to draw a height chart, scale marks, labels, lineup, or comparison diagram inside a story panel.
- Height tiers must not stretch cute droplet proportions: Muci and Artrans share the shorter tier; active Padaruna/Padarana/Snacri characters share the standard tier; Nia is only about 1.1x Padaruna.
- When Muci and Nia appear together, use their model sheets and the height reference as off-canvas guides. Keep the prompt text short: Muci broad squat/no brow/reader-left lean; Nia taller narrow/sharp point/one angled brow.
...
- Padaruna or Padarana losing their own upright pointed heads, drifting into a wrong right-leaning/side-leaning head, Padaruna losing her very sharp upright point or cute plump/chubby full rounded lower-heavy pear-bottom body, Padaruna becoming skinny, narrow, tall-stretched, delicate, Nia-shaped, Muci's squat soft protagonist droplet, Padaruna eyebrows, or a generic rounded drop with no sharp head
