# Chapter 1 scene references

These environment sheets are the locked scene pack for **Chapter 1 - Orientation Week Is a Scam**.

Use them as chapter-level references when building prompts for `gpt-image-2`. Only upload the specific scene sheets needed for the current panel so the model stays focused and consistent.
