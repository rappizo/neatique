  ...
  adminNav: [
    ...
    },
    {
      ...
      children: [
        ...
        { href: "/admin/comic/extra-story-outline", label: "Extra-Story Outline" },
        { href: "/admin/comic/extra-story-publish-center", label: "Extra-Story Publish Center" },
        { href: "/admin/comic/product-locks", label: "Product Locks" },
