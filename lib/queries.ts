...
function mapProductRecord(product: any, reviewCount: number, averageRating: number | null): ProductRecord {
  return {
    ...
    keyIngredientDetails: product.keyIngredientDetails ?? null,
    pdrnSource: product.pdrnSource ?? null,
    suitableFor: product.suitableFor ?? null,
    cautionFor: product.cautionFor ?? null,
    batchExpiryInfo: product.batchExpiryInfo ?? null,
    textureVideoUrl: product.textureVideoUrl ?? null,
