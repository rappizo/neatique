...
const COMIC_VISUAL_PRODUCTION_LOCKS = [
  ...
  "- When Muci, Nia, Snacri, Padaruna, or Padarana appear together, use the similar-character comparison reference and keep their black-and-white identities separate: Muci is the broad squat model-sheet droplet with a subtle near-center reader-left top lean and no brow, Nia is the sharper tall vertical point with one angled brow, Snacri is the fatter left-leaning quiet droplet, Padaruna is the sharp point with fuller rounder buoyant lively body, no eyebrows, eager open-dot-eye smile, and about 1.1x Muci's overall size when she appears with Muci, and Padarana is the sharp point with slimmer gentle body and closed smiling eyes.",
  ...
  "- Professor Cera Lin exact lock: draw Professor Cera Lin from comic/characters/professor-cera-lin/refs/model-sheet.jpg as a rounded six-sided hexagon mascot with exactly six sides and six rounded corners, clean controlled edges, balanced academic posture, large dot eyes, measured smile, and upper reader-left glossy highlights. Never draw Professor Cera Lin as any star shape, a five-point star, a six-point star, pentagon, Sunny Spritz-style soft star, generic polygon, or a shape with projecting star tips.",
          ...
          content: [
            {
              ...
              text: [
                ...
                "Professor Cera Lin must keep the model-sheet rounded six-sided hexagon silhouette with exactly six sides and six rounded corners, controlled academic posture, large dot eyes, measured smile, and upper reader-left glossy highlights. Never draw Professor Cera Lin as any star shape, a five-point star, a six-point star, pentagon, Sunny Spritz-style soft star, or generic polygon.",
          ...
          content: [
            {
              ...
              text: [
                ...
                "- Every Professor Cera Lin prompt must explicitly preserve her Professor Cera Lin Model Sheet Exact Lock: rounded six-sided hexagon body with exactly six sides and six rounded corners, controlled academic posture, measured smile, pure white body fill, small connected feet, and never any star shape, five-point star, six-point star, pentagon, Sunny Spritz-style soft star, or generic polygon.",
