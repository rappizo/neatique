...
import { getBrevoSettings, resolveAudienceListIds, syncBrevoAudienceEmails } from "@/lib/brevo";
import { getAudienceEmailsForSync } from "@/lib/email-marketing-audience";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    console.error("Brevo audience sync failed:", error);
