    ...
    <ComicImageTaskQueueProvider maxConcurrent={5}>
      ...
      <div className="admin-page__header">
        ...
        <p>
          ...
          image generation, approval, and publishing flow as the main comic. Choose the main episode
          it should appear after, then generate the side-story outline.
        </p>
      </div>
        ...
        <div className="admin-comic-outline-stack">
          ...
          {selectedStory ? (
            <section className="admin-form">
              ...
              <form action={updateComicExtraStoryOutlineAction} className="admin-comic-copy-grid">
              ...
              <div className="admin-comic-outline-bilingual">
                <section className="admin-comic-outline-language-pane">
                  ...
                  <pre>{parseComicBilingualText(selectedStory.outline).zh || selectedStory.outline}</pre>
                </section>
                <section className="admin-comic-outline-language-pane">
                  <div className="admin-comic-outline-language-pane__header">
                    <strong>English</strong>
                  </div>
                  <pre>{parseComicBilingualText(selectedStory.outline).en || "No English version yet."}</pre>
                </section>
              </div>
            </section>
          ) : null}
